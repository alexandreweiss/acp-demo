...
resource "aviatrix_edge_spoke_external_device_conn" "bgpolan" {
  site_id           = "ferme"
  connection_name   = "edge-gw-antwerpen-lan-router"
  gw_name           = aviatrix_edge_platform.edge-gw-antwerpen.gw_name
  bgp_local_as_num  = aviatrix_edge_platform.edge-gw-antwerpen.local_as_number
